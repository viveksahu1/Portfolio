<template>
  <footer class="p-8 text-gray-500 text-sm">
    <div class="container mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
      <p class="text-center md:text-left">© {{ new Date().getFullYear() }} Vivek Sahu. All rights reserved.</p>

      <div class="flex space-x-6">
        <a href="#" target="_blank" class="text-gray-500 hover:text-white transition-colors duration-300">
